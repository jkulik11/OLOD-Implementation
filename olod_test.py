...
def test1():
	...
	states, stms, stts, ts = Orbit.dynVar_int2([0, t_max], x_0, t_eval = np.linspace(0, t_max, num=t_steps), output="all")
	...
	print(ls)
	r0Guess = x_0[:3]
	r0Guess = r0Guess * 1.01
	v0Guess = x_0[3:]
	# v0Guess[0] = 0.1
	print(f"Orbit Guess:\n r_0 = {r0Guess}\n v_0 = {v0Guess}")
	print("Running OLOD")
	soln = olod.olod(ls, t_max, t_steps, Rss, r0Guess, v0Guess, .001, 1., 20)
